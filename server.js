...
const STAGES = {
  ...
  baumkuchen: {
    ...
    width: 1200,
    height: 800,
    mainPlatform: { x1: 300, x2: 900, y1: 700, y2: 730 },
    platforms: [
      { id: 'plat_bk1', x1: 220, x2: 470, y: 360, isRotating: false },
      { id: 'plat_bk2', x1: 730, x2: 980, y: 360, isRotating: false },
      { id: 'plat_bk3', x: 600, y: 280, length: 180, angle: 0, angularSpeed: 0.015, isRotating: true, rotateOnTouch: false, x1: 510, y1: 280, x2: 690, y2: 280 }
    ],
    blastZones: { left: -200, right: 1400, top: -300, bottom: 1200 },
    spawnPoints: [
      { x: 400, y: 400 },
      { x: 800, y: 400 },
      { x: 600, y: 200 }
